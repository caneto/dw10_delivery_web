...
class PaymentTypeItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colorAll = payment.enabled ? Colors.black : Colors.grey.shade500;

    return Container(
      decoration: BoxDecoration(
        border: Border.all(color: payment.enabled ? Colors.black54 : Colors.grey),
              ...
              child: Align(
                ...
                child: TextButton(
                  ...
                  child: Text(
                    'Editar',
                    style:
                        context.textStyles.textMedium.copyWith(color: payment.enabled ? context.colors.primary : Colors.grey.shade500),
                  ),
                ),
              ),
            )
